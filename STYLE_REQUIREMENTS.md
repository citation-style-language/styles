...
All of these language versions can be found in locales/locales.json, as a `language-names` table (see "https://github.com/citation-style-language/locales/blob/master/locales.json").

You can also use the table from the Wiki, see: "https://github.com/citation-style-language/locales/wiki".
